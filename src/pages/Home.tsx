...
export function Home() {
  ...
  return (
    <div className="home-page">
      ...
      {/* 둥근 사각형 업로드 박스 */}
      <div className="upload-container" onClick={handleClick} style={{ cursor: isUploading ? 'default' : 'pointer' }}>
          ...
          <div className="upload-content">
            ...
            <div className="file-icon">
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M19.5 18C19.5 17.1716 18.8284 16.5 18 16.5C17.1716 16.5 16.5 17.1716 16.5 18V19.5H15C14.1716 19.5 13.5 20.1716 13.5 21C13.5 21.8284 14.1716 22.5 15 22.5H16.5V24C16.5 24.8284 17.1716 25.5 18 25.5C18.8284 25.5 19.5 24.8284 19.5 24V22.5H21C21.8284 22.5 22.5 21.8284 22.5 21C22.5 20.1716 21.8284 19.5 21 19.5H19.5V18Z" fill="#171719"/>
              </svg>
            </div>
